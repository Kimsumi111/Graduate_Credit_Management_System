...
public class SignupMenuListener implements ActionListener
{
	...
	public SignupMenuListener(JTextField[] text,Windows window)
	{
	...
	public void actionPerformed(ActionEvent e)
	{
		...
		if(button.getText().equals("Sign Up"))
		{
			...
			user.setInt("Grade",0,input.stringToInt(text[2].getText(),1,3));
