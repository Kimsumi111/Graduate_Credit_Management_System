				...
				switch (Input.Int(0,4,-1))
				{
								...
								case 1:
									while(true)
									{
										if(accUser.getInt("Code",IntMem[1]) == -1)
										{
											...
											accUser.setDouble("Credit", IntMem[1], Input.Double(0.0,4.0,10));
											Print.Option(100);
											if(Input.Int(1,2,-1) == 2)
												break;
										}
								...
								case 2:
									while(true)
									{
										...
										if(IntMem[1] < 0)
											...
											accUser.setDouble("Grade", IntMem[1], Input.Double(0.0, 4.5, 11));
										Print.Option(100);
										if(Input.Int(1,2,-1) == 2)
											break;
									}
					...
					case 2:
						while(true)
						{
							...
							IntMem[2] = Print.User(accUser,Input.Int(10000000, 99999999,7));
							if(IntMem[2]>-1)
							{
								accUser.setInt("Level", IntMem[2], -1);
								accUser.setString("Term", IntMem[2], null);
								accUser.setInt("Code", IntMem[2], -1);
								accUser.setString("Classify", IntMem[2], null);
								accUser.setString("ClassName", IntMem[2], null);
								accUser.setDouble("Credit", IntMem[2], -1);
								accUser.setDouble("Grade", IntMem[2], -1);
							}
							else
								Print.Error(IntMem[1]);
							Print.Option(100);
